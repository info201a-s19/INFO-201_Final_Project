...
This stacked bar chart graphs the number of flights per month in 2015 by airline.
...
## Location of airports on US map

This map shows all the small, medium, and large airports in the United States. 
