...
ggplot(data = filtered_flights, aes(x = MONTH, y = total_flights, fill = AIRLINE, text = paste("# of FLights: ", compare_airlines$count))) +
  #geom_col(mapping = aes(x = MONTH, y = total_flights, fill = AIRLINE)) +
